...
// socket.on('update', (io) => {
//     console.log('test');
//     document.getElementById('deckCounter').innerText = 1;
//     document.getElementById('counter1').innerText = playerDecks[0].length;
//     document.getElementById('counter2').innerText = playerDecks[1].length;
// });
